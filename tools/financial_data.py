...
logger = logging.getLogger("Financial_Data_Tool")

class FinancialDataTool:
    """Tool for collecting financial data from the Financial Modeling Prep API."""
    
    def __init__(self):
        """Initialize the financial data tool with API key."""
